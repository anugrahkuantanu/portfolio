  ...
  return (
    <section id="services" className="pt-32 pb-16">
      ...
      <div className="grid grid-col-1 md:grid-cols-3 md:justify-between gap-8">
        <motion.div
          className="rounded-[20px] mx-auto relative bg-blue max-w-[400px] h-[350px] flex flex-col justify-start p-8 mt-24
        ...
        >
          <p className="text-center font-playfair font bold text-2xl mt-12 mb-3">
            UI/UX
          </p>
        ...
        <motion.div
          className="rounded-[20px] mx-auto relative bg-red max-w-[400px] h-[350px] flex flex-col justify-start p-8 mt-24
            before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.1 }}
        ...
        <motion.div
          className="rounded-[20px] mx-auto relative bg-yellow max-w-[400px] h-[350px] flex flex-col justify-start p-8 mt-24
            before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2"
          initial="hidden"
          whileInView="visible"
        ...
        >
          <p className="text-center font-bold font-playfair text-2xl mt-12 mb-3">
            Simulation
          </p>
          <p className="text-center font-playfair">
